volatile byte lastReading = 0;
volatile byte stateRegister = 0;
volatile long position = 0;


void interrupt( void )
{	
  register byte thisReading = (PORTD & 0b01100000);
  if(thisReading != lastReading)
  {
    lastReading = thisReading;
    stateRegister &= 0b00000011;
    stateRegister <<= 2;
    stateRegister |= (thisReading >> 5);
...
void setup()
{
  ...
  // WGM13:WGM10   0b1111   Fast PWM mode, cycle duration set by OCR1A
