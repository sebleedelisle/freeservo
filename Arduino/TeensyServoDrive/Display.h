...
Adafruit_SSD1306T3 display(13); // don't think this parameter does anything - might be best to leave it out

void initDisplay() {
  display.begin(SSD1306_SWITCHCAPVCC, 0x3C, true, oledpins);  // initialize with the I2C addr 0x3C
...
void updateDisplay() {
  ...
  display.print("ERROR : "); 
  display.println(errorValue, 0);
  display.print("POS   : "); 
  display.println(position, 0);
  display.print("TARGET : "); 
  display.println(targetPositionLong);
